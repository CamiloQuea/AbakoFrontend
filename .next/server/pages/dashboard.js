...
function InicioTienda() {
    const { data , error  } = swr__WEBPACK_IMPORTED_MODULE_1___default()(`https://api.abako.xyz/api/user/shop`, (url)=>(0,_lib_FetcherGet__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(url)
    );
...
function inicio() {
    const { data , error , mutate  } = swr__WEBPACK_IMPORTED_MODULE_3___default()(`https://api.abako.xyz/api/user`, (url)=>(0,_lib_FetcherGet__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(url)
    );
    if (!data) return 'Loading';
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,894,772,145], () => (__webpack_exec__(1006)));
