...
function viewDatos({ shop_id  }) {
    const { data , error , message  } = swr__WEBPACK_IMPORTED_MODULE_1___default()(`https://api.abako.xyz/api/user/shop/${shop_id}`, (url)=>(0,_lib_FetcherGet__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(url)
    );
...
function OneShop() {
    ...
    const { data , error  } = swr__WEBPACK_IMPORTED_MODULE_4___default()(`https://api.abako.xyz/api/user/shop/${id}`, (url)=>(0,_lib_FetcherGet__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(url)
    );
    if (error) return 'Error: ';
    if (!data) return 'Loading';
    const viewModal = ()=>{
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: menuopciones == 'Productos' ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Dashboard_Productos_ListProductos__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                            ...
                            shop_id: id
                        }) : menuopciones == 'Empleados' ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Dashboard_Tiendas_Empleados_ListEmpleado__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                                shop_id: id
                            })
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,894,772,861,145,506], () => (__webpack_exec__(8493)));
