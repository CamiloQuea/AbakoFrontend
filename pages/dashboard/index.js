                    ...
                    */}
                    <div className='flex flex-col rounded-xl lg:col-span-3 max-h-72 h-72  shadow-md border dark:border-prueba'>
                        ...
                        <div className="p-2 inline-flex w-full">
                            <div className="w-14 h-14 bg-white relative -my-8 ml-5 mr-3 rounded-xl shadow-lg grid grid-cols-1 dark:bg-pruebaA3 z-0">
                    ...
                    <div className='rounded-xl lg:row-span-2 lg:col-span-1 lg:row-start-1 lg:col-start-5  shadow-md h-full border dark:border-prueba flex flex-col z-0'>
